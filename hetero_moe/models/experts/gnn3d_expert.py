...
class GNN3DExpert(nn.Module):
    """Stubbed 3D-infused expert; loading of 3DInfomax weights will be added later.
    """
    ...
    def forward(self, batch: Dict):
        ...
        if input_ids is None or target_ids is None:
            raise ValueError("GNN3DExpert expects 'input_ids' and 'target_ids' in batch")

        # Produce logits aligned with target length to avoid shape mismatch
        # For the stub, ignore encoder memory and project embedded targets
