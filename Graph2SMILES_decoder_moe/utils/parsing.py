...
def add_train_args(parser):
    ...
    # -------------- MoE decoder ---------------
    group.add_argument("--moe_num_experts", help="Number of experts in MoE", type=int, default=4)
    group.add_argument("--moe_topk", help="Number of experts to route to", type=int, default=1)
    group.add_argument("--moe_gating_temperature", help="Gating softmax temperature", type=float, default=1.0)
    group.add_argument("--moe_aux_loss_factor", help="Factor for MoE load-balancing loss", type=float, default=0.01)
    # training params
